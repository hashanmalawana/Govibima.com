...
define ( 'MEDITATION_VERSION', '1.0.5' );
...
function meditation_get_defaults() {
	...
	$defaults = array(  'is_thumbnail_empty_icon' => '',
						...
						'footer_text' => '<a href="' . __( 'http://wordpress.org/', 'meditation' ) . '">' . __( 'Powered by WordPress', 'meditation' ). '</a> | ' . __( 'theme ', 'meditation' ) . '<a href="' .  __( 'https://visualpharm.com/wpblogs/themes/theme/meditation/', 'meditation') . '">Meditation</a>',
						'is_show_cat' => '1',
						/* customiser panels */
						'is_custom_colors' => '1',
						/* animation */
